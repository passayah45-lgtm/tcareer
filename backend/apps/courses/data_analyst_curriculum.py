    ...
    "excel-for-data-analysis": CourseCurriculum(
            ...
            ModuleDefinition(
                ...
                (
                    _excel_lesson(
                        ...
                        (
                            "Typing calculations directly into the raw data without keeping a backup.",
                            "Leaving tabs named Sheet1/Sheet2 so reviewers cannot understand the workbook.",
                            "Mixing notes, pivots, and raw records on the same sheet.",
                        ),
                        (
                            "Workbook has the required six tabs.",
                            "`Raw_Data` contains headers and sample records.",
                            "File is saved with a descriptive name.",
                            "Raw data is not overwritten by calculations.",
                        ),
                    ),
                    _excel_lesson(
                        ...
                        (
                            "Assuming every date format means the same thing in every country.",
                            "Formatting a text number to look numeric without converting it.",
                            "Converting IDs or phone numbers to numbers and losing leading zeros.",
                        ),
                        (
                            "Date values sort from oldest to newest correctly.",
                            "Discounts behave as percentages in formulas.",
                            "Currency columns remain numeric.",
                            "Text identifiers preserve leading zeros.",
                        ),
                    ...
                    _excel_lesson(
                        ...
                        (
                            ...
                            "Copying a formula that should use an absolute reference but uses a relative reference.",
                            "Hiding errors with IFERROR without checking why the error happened.",
                        ),
                        (
                            "Revenue equals units times unit price after discount.",
                            "Absolute references remain fixed when copied.",
                            "COUNT and COUNTA are used appropriately.",
                            "IF labels match the defined threshold.",
                        ),
                    ),
                ),
            ),
            ModuleDefinition(
                ...
                (
                    _excel_lesson(
                        ...
                        (
                            "Sorting only one selected column in a multi-column dataset.",
                            "Forgetting a filter is active and thinking rows disappeared.",
                            "Filtering formatted text dates instead of real date values.",
                        ),
                        (
                            "All columns remain aligned after sorting.",
                            "Filters can be cleared.",
                            "Numeric/date/text filters are used on appropriate data types.",
                            "The result answers the stated scenario.",
                        ),
                    ),
                    _excel_lesson(
                        "Data cleaning",
                        ...
                        (
                            "Deleting rows with missing values without checking business meaning.",
                            "Removing duplicates across all columns when only order ID should be unique.",
                            "Changing raw data without preserving a copy.",
                        ),
                        (
                            "Raw data is unchanged.",
                            "Cleaning decisions are documented.",
                            "Duplicates are handled by a defined key.",
                            "Invalid categories are flagged or corrected.",
                        ),
                    ),
                    _excel_lesson(
                        "Lookup functions",
                        ...
                        (
                            ...
                            "Assuming VLOOKUP can search to the left.",
                            "Not checking missing lookup results.",
                            "Hard-coding column numbers without documenting them.",
                        ),
                        (
                            "Lookup uses exact match for product IDs/names.",
                            "Missing values return a clear label.",
                            "Version-compatible alternative is documented.",
                            "Lookup results are spot-checked.",
                        ),
                    ...
                    _excel_lesson(
                        ...
                        (
                            "Building pivots from messy or partially selected data.",
                            "Leaving Values as Count when Sum is intended.",
                            "Forgetting to refresh after changing data.",
                            "Using a fixed range that excludes new rows.",
                        ),
                        (
                            "Source data is clean and table-based.",
                            "Values summarize by the intended calculation.",
                            "Dates group correctly.",
                            "Pivot is refreshed after source edits.",
                        ),
                    ),
                ),
            ),
                ...
                (
                    _excel_lesson(
                        ...
                        (
                            ...
                            "Starting a bar chart axis at a misleading value.",
                            "Using colors that are hard to distinguish.",
                            "Adding labels that clutter the chart.",
                        ),
                        (
                            "Chart type matches the question.",
                            "Title states the metric and period.",
                            "Axes and legends are readable.",
                            "Color use is consistent and accessible.",
                        ),
                    ),
                    _excel_lesson(
                        "Dashboard design",
                        ...
                        (
                            "Adding every chart instead of selecting the useful ones.",
                            "Using inconsistent colors or number formats.",
                            "Forgetting to define the audience.",
                            "Making slicers or filters unclear.",
                        ),
                        (
                            "Dashboard has a stated audience and purpose.",
                            "KPIs are defined.",
                            "Layout uses hierarchy and whitespace.",
                            "Insights are visible without scrolling.",
                        ),
                    ),
                    _excel_lesson(
                        ...
                        (
                            "Submitting a dashboard without documenting cleaning steps.",
                            "Using charts that do not match the question.",
                            "Changing raw data directly.",
                            "Writing recommendations that do not follow from the numbers.",
                        ),
                        (
                            "All required tabs exist.",
                            "Cleaning issues are documented.",
                            "Revenue and profit formulas are correct.",
                            "Dashboard includes KPIs, pivots/charts, insights, and recommendations.",
                            "Workbook can be reviewed without a private external file.",
                        ),
                    ),
                ),
            ),
        ...
        assessments=(
            _excel_question(
                ...
                (
                    "A workbook is the saved Excel file; a worksheet is one tab inside it.",
                    "A worksheet is the saved Excel file; a workbook is one cell.",
                    "They mean exactly the same thing.",
                    "A workbook is only used for formulas.",
                ),
                0,
            ...
            _excel_question(
                "Which cell reference stays fixed when copied from one row to another?",
                (
                    "B2",
                    "$B$2",
                    "B$2 only when copied across columns",
                    "Sheet1!B2 always changes to text",
                ),
                1,
                "`$B$2` is an absolute reference and stays fixed when copied.",
                "Formulas and functions",
            ),
            _excel_question(
                "Why should order IDs usually be stored as text?",
                (
                    "Text preserves leading zeros and avoids numeric formatting changes.",
                    "Text makes formulas faster.",
                    "Text automatically removes duplicates.",
                    "Text is required for pivot tables.",
                ),
                0,
                "IDs are labels, not quantities; storing them as text preserves their exact form.",
                "Data types and formatting",
            ),
            _excel_question(
                "What is the safest first step before cleaning a worksheet?",
                (
                    "Delete blank rows immediately.",
                    "Preserve or copy the raw data before editing.",
                    "Create a pie chart.",
                    "Sort one column only.",
                ),
                1,
                "Keeping raw data unchanged protects auditability and rollback.",
                "Data cleaning",
            ),
            _excel_question(
                "Which function is best for removing extra spaces around text?",
                ("TRIM", "COUNT", "MAX", "IFERROR"),
                0,
                "TRIM removes leading, trailing, and repeated extra spaces between words.",
                "Data cleaning",
            ),
            _excel_question(
                "When is XLOOKUP usually safer than VLOOKUP?",
                (
                    "When you need exact match, custom missing-value handling, or lookup to the left.",
                    "Only when creating charts.",
                    "Only for percentages.",
                    "When the data has no headers.",
                ),
                0,
                "XLOOKUP is more flexible and defaults to exact match behavior.",
                "Lookup functions",
            ),
            _excel_question(
                "What should you check if a pivot table shows Count instead of Sum?",
                (
                    "The field may be text or contain blanks/non-numeric values.",
                    "The workbook is always corrupted.",
                    "The chart type is wrong.",
                    "The worksheet name is too long.",
                ),
                0,
                "Excel often counts fields that are text or mixed type.",
                "Pivot tables",
            ),
            _excel_question(
                "Which chart is usually best for monthly sales trends?",
                ("Line chart", "Pie chart", "Single KPI card", "Scatter plot with no date axis"),
                0,
                "A line chart is usually best for showing change over time.",
                "Charts",
                "chart_selection",
            ),
            _excel_question(
                "Which dashboard practice improves readability?",
                (
                    "Use every chart available.",
                    "Put the most important KPIs first and keep formatting consistent.",
                    "Hide all labels.",
                    "Use random colors for each visual.",
                ),
                1,
                "A dashboard should use hierarchy, consistency, and clear labeling.",
                "Dashboard design",
            ),
            _excel_question(
                'What does `=IF(D2>=1000,"High","Standard")` return when D2 is 1250?',
                ("High", "Standard", "FALSE", "#VALUE!"),
                0,
                "1250 is greater than or equal to 1000, so the formula returns High.",
                "Formulas and functions",
                "applied_formula",
            ),
            _excel_question(
                "What does `=SUM(E2:E20)` calculate?",
                (
                    "The total of values from E2 through E20.",
                    "The average of E2 and E20 only.",
                    "The number of text cells in E2:E20.",
                    "The largest value in E2:E20.",
                ),
                0,
                "SUM adds every numeric value in the specified range.",
                "Formulas and functions",
                "applied_formula",
            ),
            _excel_question(
                "Why use `=IFERROR(G2/H2,0)` carefully?",
                (
                    "It can hide a real data-quality problem if you do not investigate the original error.",
                    "It permanently deletes the formula.",
                    "It only works in charts.",
                    "It changes dates to text.",
                ),
                0,
                "IFERROR is useful, but analysts should still understand why an error happened.",
                "Formulas and functions",
                "applied_formula",
            ),
            _excel_question(
                "If a tax rate is stored in B1 and copied down a column, which formula correctly locks B1?",
                ("=B1*C2", "=$B$1*C2", "=B$1*$C$2 for every row only", "=LOCK(B1)*C2"),
                1,
                "Absolute references lock the tax-rate cell while the row value changes.",
                "Formulas and functions",
                "applied_formula",
            ),
            _excel_question(
                "A region column contains `west`, ` West `, and `WEST`. What cleaning approach is appropriate?",
                (
                    "Trim spaces and standardize casing before analysis.",
                    "Delete the whole region column.",
                    "Treat all three as separate official regions.",
                    "Convert the values to currency.",
                ),
                0,
                "Whitespace and casing should be standardized to avoid split categories.",
                "Data cleaning",
                "data_cleaning_scenario",
            ),
            _excel_question(
                "A discount column has blank cells. What should an analyst do first?",
                (
                    "Decide and document whether blank means zero, unknown, or missing before filling values.",
                    "Replace every blank in the workbook with 100%.",
                    "Delete every row with a blank discount.",
                    "Convert the column to text.",
                ),
                0,
                "Missing-value handling depends on business meaning and must be documented.",
                "Data cleaning",
                "data_cleaning_scenario",
            ),
            _excel_question(
                "You find duplicate order IDs with identical values in all fields. What is the safest action?",
                (
                    "Confirm the duplicate rule, remove one duplicate in Clean_Data, and document the change.",
                    "Delete all records with that order ID.",
                    "Ignore duplicates because pivot tables fix them.",
                    "Change the order IDs randomly.",
                ),
                0,
                "Duplicates should be handled using a defined key and documented cleaning step.",
                "Data cleaning",
                "data_cleaning_scenario",
            ),
            _excel_question(
                "A pivot table shows revenue by month, but newly added rows are missing. What should you do?",
                (
                    "Refresh the pivot and confirm the source range/table includes the new rows.",
                    "Reinstall Excel.",
                    "Change every date to text.",
                    "Delete the pivot filters only.",
                ),
                0,
                "Pivots do not always update until refreshed, and fixed ranges may exclude new rows.",
                "Pivot tables",
                "pivot_interpretation",
            ),
            _excel_question(
                "A pivot value field is counting orders when you need total revenue. What should you change?",
                (
                    "Value Field Settings from Count to Sum, after checking the source field is numeric.",
                    "The worksheet tab color.",
                    "The legend position.",
                    "The workbook password.",
                ),
                0,
                "The summary function controls whether a field is counted or summed.",
                "Pivot tables",
                "pivot_interpretation",
            ),
            _excel_question(
                "Which chart best compares profit across product categories?",
                (
                    "Horizontal bar chart",
                    "Pie chart with 20 slices",
                    "Line chart with categories as dates",
                    "Scatter plot with no numeric x-axis",
                ),
                0,
            ...
            _excel_question(
                "Which chart is risky when showing many categories with small differences?",
                ("Pie chart", "Bar chart", "Line chart", "Column chart"),
                0,
                "Pie charts become hard to read with many categories or small differences.",
                "Charts",
                "chart_selection",
            ),
            _excel_question(
                "What must the final project `Notes` tab include?",
                (
                    "Cleaning decisions, assumptions, insights, and business recommendations.",
                    "Only copied chart images.",
                    "Passwords for protected sheets.",
                    "A list of private customer names.",
                ),
                0,
                "The Notes tab makes the analysis reviewable and explains decisions.",
                "Final dashboard project",
            ),
            _excel_question(
                "Which workbook tab should preserve the original imported records?",
                ("Raw_Data", "Dashboard", "Notes", "Pivot_Tables"),
                0,
                "Raw_Data should preserve the original source records.",
                "Final dashboard project",
            ),
            _excel_question(
                "What makes a final dashboard recommendation credible?",
                (
                    "It is supported by the cleaned data, calculations, pivots, and charts.",
                    "It sounds confident even without data.",
                    "It uses the brightest color.",
                    "It ignores low-performing categories.",
                ),
                0,
                "Recommendations must follow from the analysis evidence.",
                "Final dashboard project",
            ),
        ),
    ),
        ...
        (
            ModuleDefinition(
                ...
                (
                    _lesson(
                        "Relational concepts",
                        "Explain tables, rows, columns, keys, and relationships.",
                        "Connect customers to orders with a customer_id key.",
                        "Draw a two-table relationship diagram.",
                    ),
                    _lesson(
                        "SELECT",
                        "Retrieve specific columns from a table.",
                        "Select customer name, city, and signup date.",
                        "Write three simple SELECT queries.",
                    ),
                    _lesson(
                        "Filtering",
                        "Use WHERE to narrow query results.",
                        "Find orders above a threshold in one region.",
                        "Filter by date, category, and numeric range.",
                    ),
                    _lesson(
                        "Sorting",
                        "Use ORDER BY to rank query results.",
                        "List highest revenue products first.",
                        "Sort a query by two fields.",
                    ),
                ),
            ),
            ModuleDefinition(
                ...
                (
                    _lesson(
                        "Aggregate functions",
                        "Calculate counts, sums, averages, minimums, and maximums.",
                        "Calculate monthly revenue.",
                        "Write five aggregate queries.",
                    ),
                    _lesson(
                        "GROUP BY",
                        "Summarize records by category or period.",
                        "Group sales by region.",
                        "Group a dataset by two dimensions.",
                    ),
                    _lesson(
                        "HAVING",
                        "Filter grouped results correctly.",
                        "Find categories with more than 100 orders.",
                        "Write a grouped query with HAVING.",
                    ),
                ),
            ),
            ModuleDefinition(
                ...
                (
                    _lesson(
                        "Joins",
                        "Combine related tables without duplicating meaning.",
                        "Join orders to customers and products.",
                        "Write inner and left joins.",
                    ),
                    _lesson(
                        "Subqueries",
                        "Break complex questions into nested query steps.",
                        "Find customers above average spend.",
                        "Rewrite one query using a subquery.",
                    ),
                    _lesson(
                        "CASE",
                        "Create conditional labels in SQL.",
                        "Classify orders as low, medium, or high value.",
                        "Build a customer segment field.",
                    ),
                    _lesson(
                        "Window functions",
                        "Use window functions for rankings and running totals.",
                        "Rank products by revenue within each category.",
                        "Create a running monthly total.",
                    ),
                    _lesson(
                        "Final SQL analysis project",
                        "Answer a business question with a sequence of SQL queries.",
                        "Analyze retention or sales performance.",
                        "Submit queries plus a short insight summary.",
                    ),
                ),
            ),
        ),
        ...
        (
            ModuleDefinition(
                ...
                (
                    _lesson(
                        "Setup",
                        "Run Python code in a local or notebook environment.",
                        "Execute a print statement and simple calculation.",
                        "Set up and run your first script.",
                    ),
                    _lesson(
                        "Variables",
                        "Store and reuse values with clear variable names.",
                        "Store a user's name and score.",
                        "Create variables for a simple report.",
                    ),
                    _lesson(
                        "Data types",
                        "Distinguish strings, numbers, booleans, and None.",
                        "Convert a string number before adding.",
                        "Inspect five values and label their type.",
                    ),
                    _lesson(
                        "Operators",
                        "Use arithmetic and comparison operators.",
                        "Calculate percentage change.",
                        "Write expressions for three metrics.",
                    ),
                ),
            ),
            ModuleDefinition(
                ...
                (
                    _lesson(
                        ...
                        "Classify a score as pass or retry.",
                        "Write conditions for simple validation.",
                    ),
                    _lesson(
                        "Loops",
                        "Repeat work over sequences safely.",
                        "Loop through monthly revenue values.",
                        "Summarize values in a list.",
                    ),
                    _lesson(
                        "Functions",
                        "Wrap reusable logic in functions.",
                        "Create a function for conversion rate.",
                        "Write two small metric functions.",
                    ),
                ),
            ),
            ModuleDefinition(
                ...
                (
                    _lesson(
                        "Lists",
                        "Store ordered collections and access items.",
                        "Keep a list of product prices.",
                        "Filter a list manually.",
                    ),
                    _lesson(
                        "Tuples",
                        "Use tuples for fixed grouped values.",
                        "Represent latitude and longitude.",
                        "Create tuples for immutable records.",
                    ),
                    _lesson(
                        "Dictionaries",
                        "Use key-value data structures.",
                        "Store customer attributes.",
                        "Build a dictionary summary.",
                    ),
                    _lesson(
                        "Sets",
                        "Find unique values with sets.",
                        "Find unique regions in a list.",
                        "Remove duplicates from a sequence.",
                    ),
                    _lesson(
                        "Files",
                        "Read and write simple text files.",
                        "Read lines from a CSV-like file.",
                    ...
                    _lesson(
                        ...
                        "Add error handling to a converter.",
                    ),
                    _lesson(
                        "Modules",
                        "Import and organize reusable code.",
                        "Use the math module.",
                        "Move a helper function into a module.",
                    ),
                    _lesson(
                        "Beginner project",
                        "Build a small Python program from requirements.",
                        "Create a command-line grade summarizer.",
                        "Submit code and a short explanation.",
                    ),
                ),
            ),
        ),
            ...
            ModuleDefinition(
                ...
                (
                    _lesson(
                        ...
                        "Summarize the center, spread, and shape of data.",
                        "Describe order values with summary stats.",
                        "Summarize a numeric column.",
                    ),
                    _lesson(
                        "Mean, median, mode",
                        "Choose a suitable measure of center.",
                        "Compare income mean and median.",
                        "Calculate and interpret all three.",
                    ),
                    _lesson(
                        "Variance and standard deviation",
                        "Explain variation in a dataset.",
                        "Compare stable and volatile weekly sales.",
                        "Compute and describe spread.",
                    ),
                ),
            ),
            ModuleDefinition(
                ...
                (
                    _lesson(
                        "Probability",
                        "Reason about likelihood in analyst language.",
                        "Estimate conversion probability.",
                        "Write probability statements from counts.",
                    ),
                    _lesson(
                        "Distributions",
                        "Recognize common distribution shapes.",
                        "Compare normal and skewed data.",
                        "Sketch and describe two distributions.",
                    ),
                    _lesson(
                        "Sampling",
                        "Explain why samples can mislead.",
                        "Compare biased and random survey samples.",
                        "Evaluate a sampling method.",
                    ),
                    _lesson(
                        "Confidence intervals",
                        "Interpret a confidence interval without overclaiming.",
                        "Report a range around average order value.",
                        "Write an interval interpretation.",
                    ),
                ),
            ),
            ModuleDefinition(
                ...
                (
                    _lesson(
                        "Hypothesis testing",
                        "Explain null hypotheses and p-values at a high level.",
                        "Compare conversion before and after a change.",
                        "State a test question carefully.",
                    ),
                    _lesson(
                        "Correlation",
                        "Interpret correlation without claiming causation.",
                        "Compare ad spend and revenue.",
                        "Find risks in a correlation claim.",
                    ),
                    _lesson(
                        "Regression foundations",
                        "Explain what a simple regression estimates.",
                        "Model sales from traffic.",
                        "Interpret slope in plain language.",
                    ),
                    _lesson(
                        "Statistical interpretation",
                        "Translate statistical outputs for stakeholders.",
                        "Explain uncertainty in a dashboard note.",
                        "Rewrite a technical result for a manager.",
                    ),
                ),
            ),
        ),
...
def _simple_course(slug: str, title: str, topics: tuple[str, ...]) -> CourseCurriculum:
    ...
    return CourseCurriculum(
        slug,
        (
            f"Apply core {title.lower()} skills to data analyst work.",
            "Produce reviewable evidence of learning.",
        ),
